...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {      
    [0] = LAYOUT_65_ansi_blocker(
        ...
        MO(1), KC_LCTRL, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_RALT,   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, 7_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, _______, _______, _______, _______,          KC_PGUP, KC_VOLD, \
